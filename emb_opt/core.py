...
# %% auto 0
__all__ = ['build_batch_from_embeddings', 'build_batch_from_items', 'Module', 'Executor', 'ProcessExecutor', 'ThreadExecutor',
           'DatasetExecutor']

# %% ../nbs/02_core.ipynb 3
from .imports import *
from .utils import batch_list, unbatch_list
from .schemas import Batch, Embedding, Query, Item
...
# %% ../nbs/02_core.ipynb 5
def build_batch_from_items(items: List[Item]) -> Batch:
    queries = []
