...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'emb_opt.data_source': { 'emb_opt.data_source.DataSourceModule': ( 'data_source.html#datasourcemodule',
                                     ...
                                     'emb_opt.data_source.NumpyDataPlugin.__init__': ( 'data_source.html#numpydataplugin.__init__',
                                                                                       'emb_opt/data_source.py')},
            'emb_opt.executor': { 'emb_opt.executor.DatasetExecutor': ('executor.html#datasetexecutor', 'emb_opt/executor.py'),
                                  'emb_opt.executor.DatasetExecutor.__init__': ( 'executor.html#datasetexecutor.__init__',
                                                                                 'emb_opt/executor.py'),
                                  'emb_opt.executor.DatasetExecutor.batch_inputs': ( 'executor.html#datasetexecutor.batch_inputs',
                                                                                     'emb_opt/executor.py'),
                                  'emb_opt.executor.DatasetExecutor.execute': ( 'executor.html#datasetexecutor.execute',
                                                                                'emb_opt/executor.py'),
                                  'emb_opt.executor.DatasetExecutor.unbatch_inputs': ( 'executor.html#datasetexecutor.unbatch_inputs',
                                                                                       'emb_opt/executor.py'),
            ...
            'emb_opt.schemas': { 'emb_opt.schemas.Batch': ('schemas.html#batch', 'emb_opt/schemas.py'),
                                 ...
                                 'emb_opt.schemas.InteralData._fill_data': ('schemas.html#interaldata._fill_data', 'emb_opt/schemas.py'),
