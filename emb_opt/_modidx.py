...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'emb_opt.core': { 'emb_opt.core.DatasetExecutor': ('core.html#datasetexecutor', 'emb_opt/core.py'),
                              ...
                              'emb_opt.core.build_batch_from_items': ('core.html#build_batch_from_items', 'emb_opt/core.py')},
            'emb_opt.data_source': { 'emb_opt.data_source.DataSourceModule': ( 'data_source.html#datasourcemodule',
                                     ...
                                     'emb_opt.data_source.DataSourceModule.scatter_results': ( 'data_source.html#datasourcemodule.scatter_results',
                                                                                               'emb_opt/data_source.py'),
                                     'emb_opt.data_source.HugggingfaceDataPlugin': ( 'data_source.html#hugggingfacedataplugin',
                                                                                     'emb_opt/data_source.py'),
                                     'emb_opt.data_source.HugggingfaceDataPlugin.__call__': ( 'data_source.html#hugggingfacedataplugin.__call__',
                                                                                              'emb_opt/data_source.py'),
                                     'emb_opt.data_source.HugggingfaceDataPlugin.__init__': ( 'data_source.html#hugggingfacedataplugin.__init__',
                                                                                              'emb_opt/data_source.py'),
                                     'emb_opt.data_source.NumpyPlugin': ('data_source.html#numpyplugin', 'emb_opt/data_source.py'),
                                     'emb_opt.data_source.NumpyPlugin.__call__': ( 'data_source.html#numpyplugin.__call__',
                                                                                   'emb_opt/data_source.py'),
                                     'emb_opt.data_source.NumpyPlugin.__init__': ( 'data_source.html#numpyplugin.__init__',
                                                                                   'emb_opt/data_source.py')},
            ...
            'emb_opt.prune': { 'emb_opt.prune.PruneModule': ('prune.html#prunemodule', 'emb_opt/prune.py'),
                               ...
                               'emb_opt.prune.TopKPrune.local_prune': ('prune.html#topkprune.local_prune', 'emb_opt/prune.py'),
            ...
            'emb_opt.schemas': { 'emb_opt.schemas.Batch': ('schemas.html#batch', 'emb_opt/schemas.py'),
                                 ...
                                 'emb_opt.schemas.ScoreResponse._fill_data': ( 'schemas.html#scoreresponse._fill_data',
                                                                               'emb_opt/schemas.py'),
                                 'emb_opt.schemas.UpdateResponseValidator': ('schemas.html#updateresponsevalidator', 'emb_opt/schemas.py')},
