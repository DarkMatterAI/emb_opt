...
# %% auto 0
__all__ = ['Embedding', 'DataSourceFunction', 'FilterFunction', 'ScoreFunction', 'PruneFunction', 'UpdateFunction',
           'DiscreteUpdateFunction', 'ContinuousUpdateFunction', 'Item', 'Query', 'Batch', 'DataSourceResponse',
           'FilterResponse', 'ScoreResponse', 'PruneResponse', 'ContinuousUpdateResponse']
...
DiscreteUpdateFunction = Callable[List[Query], List[Item]]

ContinuousUpdateFunction = Callable[List[Query], List[ContinuousUpdateResponse]]
