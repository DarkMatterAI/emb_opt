...
# %% auto 0
__all__ = ['Embedding', 'DataSourceFunction', 'FilterFunction', 'ScoreFunction', 'PruneFunction', 'UpdateResponse',
           'UpdateFunction', 'Item', 'Query', 'Batch', 'DataSourceResponse', 'FilterResponse', 'ScoreResponse',
           'PruneResponse', 'ContinuousUpdateResponse', 'UpdateResponseValidator']
...
class Item(BaseModel):
    ...
    def _fill_data(cls, inputs: Any) -> Any:
        ...
        assert 'query_results' not in inputs
        assert 'parent_query' not in inputs
...
UpdateResponse = Union[List[ContinuousUpdateResponse], List[Item], List[Query], Batch]

UpdateFunction = Callable[Batch, UpdateResponse]

class UpdateResponseValidator(BaseModel):
